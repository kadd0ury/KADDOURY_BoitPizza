                ...
                <table class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="border-0 align-middle"><strong>{{$product->subtotal()}}€</strong></td>
      ...
      <div class="col-lg-6">
        ...
        <div class="p-4">
          ...
          <ul class="list-unstyled mb-4">
            <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Sous totaux</strong><strong>${{Cart::subtotal()}}</strong></li>
          ...
          </ul><a href="{{route ('checkout.index')}}" class="btn btn-dark rounded-pill py-2 btn-block">Payer votre Commande</a>
        </div>
      </div>
    </div>
</section>
