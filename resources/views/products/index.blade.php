...
<section class="story-area bg-seller color-white pos-relative">
        ...
        <div class="container">
                ...
                <div class="row">
                        <div class="col-lg-3 col-md-4  col-sm-6 ">
                                <div class="center-text mb-30">
                                        <div class="ïmg-200x mlr-auto pos-relative">
                                                ...
                                                <img src="assets/images/seller-2-200x200.png" alt="">
                                        </div>
                        ...
                        <div class="col-lg-3 col-md-4  col-sm-6 ">
                                <div class="center-text mb-30">
                                        <div class="ïmg-200x mlr-auto pos-relative"><img src="assets/images/seller-2-200x200.png" alt=""></div>
                                        <h5 class="mt-20">Pizza Margherita</h5>
                                        <h4 class="mt-5"><b>$11.90</b></h4>
                                        <h6 class="mt-20"><a href="#" class="btn-brdr-primary plr-25"><b>Order Now</b></a></h6>
                                </div><!--text-center-->
                ...
                <div class="row">
                        <div class="col-sm-12">
                                <ul class="selecton brdr-b-primary mb-70">
                                        ...
                                        <li><a href="#" data-select="pasta"><b>Boissons</b></a></li>
                                        <li><a href="#" data-select="salads"><b>Salades</b></a></li>
